                      ...
                      "div",
                      {
                        ...
                        children: settings.cta_cards && settings.cta_cards.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "w-full grid grid-cols-2 gap-3", children: settings.cta_cards.sort((a2, b) => a2.order - b.order).map((card2, index) => {
                          ...
                          import_framer_motion12.motion.div,
                          {
                            ...
                            children: shouldEscapeInAppBrowser && link.destination_url ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                              "a",
                              {
                                ...getNativeLinkProps(link.destination_url),
                                className: "block w-full",
                                children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(card_default, { className: "w-full hover:scale-[1.02] transition-transform shadow-lg", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(card_body_default, { className: "p-6", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "flex items-center justify-between", children: [

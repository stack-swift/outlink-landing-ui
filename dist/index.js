...
function LandingPageViewer({
  ...
  const ctaVideoMapRef = (0, import_react21.useRef)(/* @__PURE__ */ new Map());
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
    "div",
    {
      ...
      children: [
        isVideoMode && (settings.header_video_poster_url || settings.avatar_url) ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "div",
          {
        ...
        ) : settings.avatar_url ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "div",
          {
            className: "hidden md:block absolute inset-0 z-0",
            style: {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
          "div",
          {
            ...
            children: [
              isFreePlan && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                "a",
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "w-full bg-gradient-to-r from-[#C9A24B] to-[#4FB6C4] py-2 px-4 shadow-md flex items-center justify-center gap-2", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "text-[10px] font-semibold tracking-[0.15em] text-white uppercase", children: "Claim your domain" }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "w-full max-w-md", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "flex flex-col items-center gap-4", children: [
                    ...
                    isSectionEnabled("cta_block") && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                      "div",
                      {
                        ...
                        children: settings.cta_cards && settings.cta_cards.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "w-full grid grid-cols-2 gap-3", children: settings.cta_cards.sort((a, b) => a.order - b.order).map((card, index) => {
                          ...
                          const isOnlyfansLogo = (card.style.logo_icon || "").toLowerCase().includes("onlyfans") || card.style.logo_icon === "of-local" || (card.style.logo_name || "").toLowerCase() === "icon";
                          const isBrandedNonOF = !!card.style.logo_icon && !isOnlyfansLogo;
                            ...
                            "div",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "text-center w-full relative z-10", children: [
                                  isOnlyfansLogo && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "mb-2", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "flex flex-col items-center gap-1", children: [
                                  ...
                                  !isBrandedNonOF && card.title && card.title.trim() !== "" && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                                    "h3",
                                    {
                                  ...
                                  !isBrandedNonOF && card.description && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                                    "p",
                                    {
                                ...
                                isBrandedNonOF && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
                    ...
                    isSectionEnabled("branding") && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
                      import_framer_motion10.motion.div,
                      {
                        initial: { opacity: 0 },
                        animate: { opacity: 1 },
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
                          "a",
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { children: "Powered by Halevora" })
                            ]
                          }
                        )
                      }

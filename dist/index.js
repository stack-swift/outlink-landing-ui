...
function ClickToReveal({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "relative overflow-hidden rounded-xl", children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "absolute inset-0 bg-black/10 z-[5] flex flex-col items-center justify-center px-4 py-4 rounded-xl", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
...
function CountdownReveal({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "relative overflow-hidden rounded-xl", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "absolute inset-0  bg-black/10 z-[5] flex flex-col items-center justify-center px-4 py-3 rounded-xl", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
...
function ProgressBarReveal({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "relative overflow-hidden rounded-xl", children: [
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "absolute rounded-xl inset-0 backdrop-blur-sm bg-black/40 z-[5] flex items-center justify-center px-3 py-3", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_framer_motion8.motion.div, { className: "text-center space-y-1 w-full max-w-[210px] mx-auto", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "space-y-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("p", { className: "text-white font-semibold text-sm drop-shadow-md", children: message }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
          progress_default,
          {
            value: progress2,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("p", { className: "text-white/80 text-[11px] drop-shadow-sm", children: [
...
function CTACardWithMechanisms({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "relative overflow-hidden rounded-xl", children: [
    showBadges && ((_n = mechanisms == null ? void 0 : mechanisms.limited_slots) == null ? void 0 : _n.enabled) && /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      ScarcityBadge,
      {
        type: "slots",
    ...
    showBadges && ((_o = mechanisms == null ? void 0 : mechanisms.live_viewers) == null ? void 0 : _o.enabled) && /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      ScarcityBadge,
      {
        type: "viewers",
    ...
    showBadges && ((_p = mechanisms == null ? void 0 : mechanisms.exclusive_badge) == null ? void 0 : _p.enabled) && /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      import_framer_motion10.motion.div,
      {
        initial: { opacity: 0, scale: 0.8 },
        animate: { opacity: 1, scale: 1 },
...
function LandingPageViewer({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
    "div",
    {
      ...
      children: [
        isVideoMode && (settings.header_video_poster_url || settings.avatar_url) ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
          "div",
          {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "w-full max-w-md", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "flex flex-col items-center gap-4", children: [
                    (isFullMode || isVideoMode) && isSectionEnabled("header") && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
                      import_framer_motion12.motion.div,
                      {
                    ...
                    mode === "avatar" && isSectionEnabled("header") && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
                      import_framer_motion12.motion.div,
                      {
                        initial: { opacity: 0, y: 10 },
                        animate: { opacity: 1, y: 0 },
                    ...
                    isSectionEnabled("social_block") && (settings.social_links && settings.social_links.length > 0 || settings.show_follower_count && (settings.follower_count || 0) > 0) && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
                      "div",
                      {
                        className: `flex flex-col items-center gap-2 ${getSectionSpacingClass(
                          "social_block"
                    ...
                    isSectionEnabled("voice_note") && settings.voice_note_url && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                      import_framer_motion12.motion.div,
                      {
                        initial: { opacity: 0, y: 10 },
                        animate: { opacity: 1, y: 0 },
                    ...
                    isSectionEnabled("bio") && settings.bio && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                    ...
                    isSectionEnabled("cta_block") && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                      "div",
                      {
                        ...
                        children: settings.cta_cards && settings.cta_cards.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "w-full grid grid-cols-2 gap-3", children: settings.cta_cards.sort((a2, b) => a2.order - b.order).map((card2, index) => {
                          ...
                          const renderCardBodyContent = () => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
                            "div",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "text-center w-full relative z-10", children: [
                                  ...
                                  !isBrandedNonOF && card2.title && card2.title.trim() !== "" && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                                    "h3",
                                    {
                                  ...
                                  !isBrandedNonOF && card2.description && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                                    "p",
                                    {
                                ...
                                isBrandedNonOF && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
                                  card2.style.logo_icon && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "absolute top-2 right-2 z-20", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                                    "div",
                                    {
                                  ...
                                  card2.style.logo_name && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "absolute bottom-1 left-1/2 -translate-x-1/2 z-20", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                                    "p",
                                    {
                          ...
                          const renderCardContent = () => /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                            card_default,
                            {
                              ...
                              style: getCardStyle(),
                              children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(card_body_default, { children: renderCardBodyContent() })
                            }
                          );
                          const baseCardContent = cardLinkProps ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                            "a",
                            {
                          ...
                          import_framer_motion12.motion.div,
                          {
                            ...
                            children: !isPreview && link.destination_url ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                              "a",
                              {
                                ...
                                children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "p-6", children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "flex items-center justify-between", children: [
                    ...
                    isSectionEnabled("gallery") && hasGallery && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                      import_framer_motion12.motion.div,
                      {
                        initial: { opacity: 0, y: 10 },
                        animate: { opacity: 1, y: 0 },
                    ...
                    isSectionEnabled("branding") && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                      import_framer_motion12.motion.div,
                      {
                        initial: { opacity: 0 },
                        animate: { opacity: 1 },

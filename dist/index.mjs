...
import { useState as useState8, useEffect as useEffect5, useRef as useRef2 } from "react";
...
function CTACardWithMechanisms({
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "relative overflow-hidden rounded-xl", children: [
...
function LandingPageViewer({
  ...
  return /* @__PURE__ */ jsxs8(
    "div",
    {
      ...
      children: [
        isVideoMode && (settings.header_video_poster_url || settings.avatar_url) ? /* @__PURE__ */ jsx10(
          "div",
          {
        ...
        ) : settings.avatar_url ? /* @__PURE__ */ jsx10(
          "div",
          {
            className: "hidden md:block absolute inset-0 z-0",
            style: {
                            ...
                            "div",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsxs8("div", { className: "text-center w-full relative z-10", children: [
                                  isOnlyfansLogo && /* @__PURE__ */ jsx10("div", { className: "mb-2", children: /* @__PURE__ */ jsxs8("div", { className: "flex flex-col items-center gap-1", children: [
                                  ...
                                  !isBrandedNonOF && card.title && card.title.trim() !== "" && /* @__PURE__ */ jsx10(
                                    "h3",
                                    {
                                  ...
                                  !isBrandedNonOF && card.description && /* @__PURE__ */ jsx10(
                                    "p",
                                    {
                                ...
                                isBrandedNonOF && /* @__PURE__ */ jsxs8(Fragment7, { children: [

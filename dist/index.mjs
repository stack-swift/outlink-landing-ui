...
function CTAUrgencyBadge({
  ...
  return /* @__PURE__ */ jsx10("div", { className: "mt-1 inline-flex max-w-full items-center rounded-md bg-black px-3 py-1 text-xs font-bold leading-none shadow-[0_10px_24px_rgba(0,0,0,0.36)]", children: /* @__PURE__ */ jsx10("span", { className: "truncate text-[#5EC8D6]", children: text }) });
}
